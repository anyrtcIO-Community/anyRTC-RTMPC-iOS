...
##模拟器库
由于Github 上限制文件大小，顾demo 中的库是基于armv7,armv7s,arm64的，如果想在模拟器中调试(armv7,armv7s,arm64,x86_64)，请前往[百度云](https://pan.baidu.com/s/1b8XLD0)下载，我们会同时同步库的,给您带来的不便，敬请原谅~</br>
#优势</br>
**超低延时**</br>
**超低内存**</br>
